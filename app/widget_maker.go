...
import (
	...
	"github.com/wtfutil/wtf/modules/mail"
...
func MakeWidget(
	...
	case "mail":
		settings := mail.NewSettingsFromYAML(moduleName, moduleConfig, config)
		widget = mail.NewWidget(tviewApp, redrawChan, pages, settings)
	case "mercurial":
